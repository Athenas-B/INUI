 ...
 * @author olda9
 */
public class Stavy_listem_AStar1_z {
...
//                    }
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        try (ObjectInputStream oos
            ...
            for (Stav st : start) {
                Stavy_listem_AStar1_z s = new Stavy_listem_AStar1_z();
                System.out.println("Hledání cesty algoritmem A* ze stavu " + st);
                List<Stav> p1 = s.getPath4(st, c);
                List<ukol2_jinak.Stav> q1 = (List<ukol2_jinak.Stav>) oos.readObject();
                System.out.println("Řešení po " + q1.size() + " krocích při " + s.openQueue.size() + " stavech ve frontě a " + s.closedList.size() + " v closed za expandovani " + " stavů:");
                for (ukol2_jinak.Stav stav : q1) {
